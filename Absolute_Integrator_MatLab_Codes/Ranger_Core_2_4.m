...
if floor(now) > 735873 && strcmp(licenseStatus,'Online - valid') == 0 % Date should match here and in warning string below.
    ...
    msgbox (horzcat('This offline copy of ',version_string,' has expired. Please connect to the internet and retry. For a new license please contact ranger-support@lewysjones.com .'), version_string , 'warn')
else
    ...
    if strcmp(licenseStatus,'Online - valid') == 0
        ...
        expiration_string = horzcat('This offline copy of ',version_string,' will expire on ',expiration_string,'. To upgrade your license please contact ranger-support@lewysjones.com .') ;
